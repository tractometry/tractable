...
`tractable_single_tract` function. This model will use "group" and "age" to
...
```{r fit no ac model}
gam_fit_cst_no_ac <- tractable::tractable_single_tract(
  df_afq         = sarica,
...
gam_fit_cst <- tractable::tractable_single_tract(
  df_afq         = sarica,
  tract          = "Right Corticospinal",
  participant_id = "subjectID",
  group_by       = "group",
